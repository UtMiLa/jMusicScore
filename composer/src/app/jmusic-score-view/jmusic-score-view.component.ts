        ...
        { 'id': '93', 't': 'Meter', 'def': { 'abs': { 'num': 1, 'den': 1 }, 'def': { 't': 'Regular', 'num': 3, 'den': 4 } } },
        {
            ...
            'children': [
                ...
                { 'id': '98', 't': 'Key', 'def': { 'abs': { 'num': 1, 'den': 1 }, 'def': { 't': 'Regular', 'acci': 'b', 'no': 3 } } },
                {
                    ...
                    'children': [
                        {'id': '999', 't': 'Sequence', children : [
                            { 'id': '100', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 8 }, 'abs': { 'num': 0, 'den': 1 },
                            'noteId': 'n1_8', 'dots': 1, 'rest': true } },
                            {
                                'id': '101', 't': 'Note',
                                'def': { 'time': { 'num': 1, 'den': 16 }, 'abs': { 'num': 3, 'den': 16 }, 'noteId': 'n1_16' },
                                'children': [{ 'id': '102', 't': 'Notehead', 'def': { 'p': 2, 'a': '' } },
            ...
            'children': [
                ...
                { 'id': '98', 't': 'Key', 'def': { 'abs': { 'num': 1, 'den': 1 }, 'def': { 't': 'Regular', 'acci': 'b', 'no': 3 } } },
                {
                    ...
                    'children': [
                        ...
                        { 'id': '103', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 8 }, 'abs': { 'num': 1, 'den': 4 },
                         'noteId': 'n1_8' }, 'children': [{ 'id': '104', 't': 'Notehead', 'def': { 'p': 4, 'a': '' } },
                         { 'id': '157', 't': 'TextSyllable', 'def': { 'text': 'på ' } }] },
                        { 'id': '105', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 8 }, 'abs': { 'num': 3, 'den': 8 },
                         'noteId': 'n1_8' }, 'children': [{ 'id': '106', 't': 'Notehead', 'def': { 'p': 6, 'a': '' } },
                         { 'id': '158', 't': 'TextSyllable', 'def': { 'text': 'teks-' } }] },
                        { 'id': '107', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 8 }, 'abs': { 'num': 1, 'den': 2 },
                         'noteId': 'n1_8', 'grace': 'normal' }, 'children': [{ 'id': '108', 't': 'Notehead',
                         'def': { 'p': 5, 'a': '' } }, { 'id': '162', 't': 'TextSyllable', 'def': { 'text': 'ten' } }] },
                        {
                            'id': '109', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 16 }, 'abs': { 'num': 1, 'den': 2 },
                            'noteId': 'n1_16' }, 'children': [{ 'id': '110', 't': 'Notehead', 'def': { 'p': 4, 'a': '' } },
                            { 'id': '111', 't': 'Notehead', 'def': { 'p': 6, 'a': '' } },
                            { 'id': '167', 't': 'NoteLongDecoration', 'def': { 'type': 2, 'dur': { 'num': 3, 'den': 16 } } }]
                        },
                        { 'id': '112', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 16 }, 'abs': { 'num': 9, 'den': 16 },
                        'noteId': 'n1_16' }, 'children': [{ 'id': '113', 't': 'Notehead', 'def': { 'p': 2, 'a': '', 'tie': true } },
                        { 'id': '114', 't': 'Notehead', 'def': { 'p': 5, 'a': '' } }] },
                        { 'id': '115', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 16 }, 'abs': { 'num': 5, 'den': 8 },
                        'noteId': 'n1_16' }, 'children': [{ 'id': '116', 't': 'Notehead', 'def': { 'p': 2, 'a': '' } },
                        { 'id': '117', 't': 'Notehead', 'def': { 'p': 4, 'a': '' } }] },
                        { 'id': '118', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 16 }, 'abs': { 'num': 11, 'den': 16 },
                        'noteId': 'n1_16' }, 'children': [{ 'id': '119', 't': 'Notehead', 'def': { 'p': 1, 'a': '' } },
                        { 'id': '120', 't': 'Notehead', 'def': { 'p': 3, 'a': '' } }] },
                        { 'id': '121', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 8 }, 'abs': { 'num': 3, 'den': 4 },
                        'noteId': 'n1_8', 'dots': 2 }, 'children': [{ 'id': '122', 't': 'Notehead', 'def': { 'p': 2, 'a': '' } }] },
                        { 'id': '123', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 32 }, 'abs': { 'num': 31, 'den': 32 },
                        'noteId': 'n1_32' }, 'children': [{ 'id': '124', 't': 'Notehead', 'def': { 'p': 2, 'a': '' } }] },
                        { 'id': '125', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 4 }, 'abs': { 'num': 1, 'den': 1 },
                        'noteId': 'n1_4' }, 'children': [{ 'id': '126', 't': 'Notehead', 'def': { 'p': 1, 'a': '' } }] },
                        { 'id': '127', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 4 }, 'abs': { 'num': 5, 'den': 4 },
                        'noteId': 'n1_4' }, 'children': [{ 'id': '128', 't': 'Notehead', 'def': { 'p': 3, 'a': '' } }] },
                        { 'id': '129', 't': 'Note', 'def': { 'time': { 'num': 1, 'den': 4 }, 'abs': { 'num': 3, 'den': 2 },
                        'noteId': 'n1_4' }, 'children': [{ 'id': '130', 't': 'Notehead', 'def': { 'p': 5, 'a': '' } }] }]
                },
                {
                    'id': '131', 't': 'Voice', 'def': { 'stem': 2 },
                    'children': [
