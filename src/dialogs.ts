module jMusicScore {
    ...
    export function CreateMenus(app: ScoreApplication.ScoreApplication) {
        ...
        $('.clef')
            ...
            .next()
            .text('e_' + $(this).prev().attr('id')) // todo: fjern svg
            /*.svg(function (svg, error) {
                svg.path(emmentaler_notes['e_' + $(this).prev().attr('id')], { transform: 'scale(0.7,0.7), translate(10,26)' });
            })*/
            .height(30)
            .width(30)
