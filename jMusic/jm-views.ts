...
import { NoteDecorations } from './jm-glyph-details';
    ...
    import {MusicEditors} from "./jMusicScore.Editors";*/
        ...
        export module Views {
            ...
            class ExpressionFactory implements IVisitorIterator, IVisitor {
            ...
            export class DomCheckSensorsVisitor implements IVisitor { // todo: remove event handlers when inactive
                ...
                visitTextSyllable(textSyllable: ITextSyllableElement, textSpacing: ITextSyllableSpacingInfo) {
                }
                visitBar(bar: IBar, spacing: IBarSpacingInfo) {
    ...
    */
            ...
            export class PrefixVisitor implements IVisitorIterator {
